...
Hannah besteht aus mehreren eigenständigen Diensten. Nur [Core](core/index.md) ist
zwingend nötig — alles andere ist optional und wird bei Bedarf dazugeschaltet.
...
| [WebUI](webui/index.md) | Web-Oberfläche zur Steuerung und Konfiguration | Nein |
